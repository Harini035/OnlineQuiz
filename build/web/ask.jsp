        ...
        <div class="center_box">
            ...
            <div id="menu_tab">                                     
                  <ul class="menu">                                                                         
                         ...
                         <li><a href="ask.jsp" class="nav">Contact Us</a></li>
                         <li class="divider"></li>
						 <li><a href="makequiz.jsp" class="nav">Create quiz</a></li>
						 <li class="divider"></li>
...
<span class="orange">Email:</span> <a href="quiz@gmail.com">info@company.com</a><br>
                        </p>
                	</div>
                </div>
